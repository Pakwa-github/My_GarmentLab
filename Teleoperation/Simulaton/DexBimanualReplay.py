...
class DexRightEnv(BaseEnv):
    def __init__(self):
        ...
        garment_config = GarmentConfig(
            usd_path="/home/pakwa/GPs/GarmentLab/Assets/Garment/Tops/Hooded_Lsleeve_FrontOpen/THLO_Jacket065/THLO_Jacket065_obj.usd",
...
env = DexRightEnv()
env.reset()
env.replay("Assets/Replays/20240806-08_47_16.npy")
