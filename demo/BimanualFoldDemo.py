...
#     env=BimanualEnv(garment_config=GarmentConfig(usd_path="/home/pakwa/GarmentLab/Assets/Garment/Trousers/Long/PL_059/PL_059_obj.usd",pos=np.array([0.3317,-0.5,0.3]),scale=np.array([0.006,0.006,0.006])))
#     env.reset()
...
if __name__=="__main__":
    garment_config=GarmentConfig(usd_path="/home/pakwa/GarmentLab/Assets/Garment/Trousers/Long/PL_059/PL_059_obj.usd",pos=np.array([0.3317,-0.5,0.3]),scale=np.array([0.006,0.006,0.006]))
