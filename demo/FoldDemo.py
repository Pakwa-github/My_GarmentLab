...
if __name__=="__main__":
    garment_config=GarmentConfig(usd_path="D:\\isaac\\GarmentLab\\Assets\\Garment\\Tops\\NoCollar_Lsleeve_FrontClose\\TNLC_Dress057\\TNLC_Dress057_obj.usd",pos=np.array([0,-0.95,0.3]),ori=np.array([0,0,0]),particle_contact_offset=0.01)
