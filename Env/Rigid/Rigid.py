...
class RigidStore():
    def __init__(self):
        add_reference_to_stage(usd_path="D:\\isaac\\GarmentLab\\Assets\\Articulated\\cabinet.usd",prim_path="/World")
        # self.rigid_form=XFormPrim(
...
class RigidTable:
    def __init__(self,world:World):
        add_reference_to_stage("D:\\isaac\\GarmentLab\\Assets\\Scene\\Willow.usd","\\World\\table")  
