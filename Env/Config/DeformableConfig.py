...
class DeformableConfig:
    def __init__(self,usd_path:str="D:\\isaac\\GarmentLab\\Assets\\Garment\\Hat\\HA_Hat007\\HA_Hat007_obj.usd",pos:np.ndarray=None,ori:np.ndarray=None,scale:np.ndarray=None,visual_material_usd:str="D:\\isaac\\GarmentLab\\Assets\\Material\\linen_Pumpkin.usd",youngs_modulus:float=None):
        if pos is None:
