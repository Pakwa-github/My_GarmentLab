...
class InflatebleConfig:
    def __init__(self,pos:np.ndarray=None,ori:np.ndarray=None,scale:np.ndarray=None,pressure:float=8.0,visual_material_usd:str="D:\\isaac\\GarmentLab\\Assets\\Material\\linen_Pumpkin.usd"):
        if pos is None:
