...
class TactileFranka:
    def __init__(self,world:World,Position=None,prim_path:str=None,robot_name:str=None,):
        ...
        self.world.scene.add(Franka(prim_path=self._franka_prim_path,usd_path="/home/pakwa/Tactile/IsaacTac/Robot/Franka/franka.usd",name=self._franka_robot_name,position=Position))
