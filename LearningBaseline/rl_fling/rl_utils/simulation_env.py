...
class SimEnv(BaseEnv):
    ...
    def step(self,action, eval_succ = False):
        ...
        self.control.grasp(pos=[action_1, action_2],ori=[None, None],flag=[True, True])
    ...
    def compute_reward_action(self, action_1, action_2):
        ...
        reward_1 = 0.25 - error_1
        reward_2 = 0.25 - error_2
        reward_1 = reward_1 if reward_1 < 0 else 1/(0.3 - reward_1)
        reward_2 = reward_2 if reward_2 < 0 else 1/(0.3 - reward_2)
