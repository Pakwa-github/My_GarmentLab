...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', type=str, default="D:\\isaac\\isaacgarment\\affordance\\") 
    # parser.add_argument('--eval_path', type=str, default="/home/isaac/isaacgarment/affordance/")  
    parser.add_argument('--eval_path', type=str, default="D:\\isaac\\isaacgarment\\affordance\\")
