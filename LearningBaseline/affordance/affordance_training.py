...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_path', type=str, default="/home/pakwa/GPs/isaacgarment/affordance/")
    parser.add_argument('--eval_path', type=str, default="/home/pakwa/GPs/isaacgarment/affordance/")
